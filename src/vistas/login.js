    ...
    script: async()=>{
      document.querySelector('#enviar').addEventListener("click", async(e)=>{ //detecto el click en el boton enviar 
        ...
        try {
          ...
          document.querySelector('main').innerHTML = login.template //vuelvo a pintar el panel para poder realizar alguna accion
          login.script() //cargo la funcionalidad del panel
